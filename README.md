...
## 📌 프로젝트 개요 
**MyPerfume**은 향수 전문 지식이 없어도  
사용자의 **스타일·색감·계절** 맥락을 분석하여 최적의 향수를 제안하는 개인화 추천 서비스입니다.
...
- 스타일: 패션 무드와 향조 간의 이미지 연관성 반영

- 색상: 의류 색감과 향기 사이의 공감각적 연결 활용

- 계절: 계절 및 기온에 따른 향의 확산력과 지속력 특성 고려
