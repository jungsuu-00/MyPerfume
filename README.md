...
**[스타일 분류 모델링_상세 설명 링크](https://github.com/jungsuu-00/MyPerfume/blob/main/code/2_style%20classification%20modeling/README_modeling.md)**  

**[추천 알고리즘_상세 설명 링크](https://github.com/jungsuu-00/MyPerfume/blob/main/code/3_recommendation%20algorithm/README_algorithm.md)**
...
## 🚀 향후 계획
최종 목표: **추천과 구매가 자연스럽게 연결되는 AI 커머스 플랫폼으로 발전**

- 추천 결과를 구매 페이지와 연결하여 사용자 이탈 최소화
- 브랜드 제휴 및 제휴 링크 기반 수익 모델 확장
...
| 기간 | 수행 내용 |
|:--:|:--:|
| 2025.11.21 ~ 11.29 | 요구사항 정의, 프로젝트 기획, WBS 설계, UI 설계 |
| 2025.12.02 ~ 12.08 | 향수 데이터 수집, 의류 이미지 전처리 |
| 2025.12.08 ~ 12.23 | 스타일 분류 모델 개발, 추천 알고리즘 구현, LLM 연동 |
| 2025.12.28 ~ 12.30 | 추천 성능 평가, 가중치 튜닝 및 자동화 |
| 2025.12.03 ~ 12.31 | Django UI, REST API, DB 설계, AWS 배포 |
...
| 팀장 · 기획<br/>데이터 분석 및 모델링 | 프론트 & 백엔드 구축<br/>데이터 모델링 | 클라우드 엔지니어<br/>백엔드 구축 |

### 한 줄 소감 

|팀원|소감|
|:--:|:--:|
| 양원선 | 기획부터 배포까지 전 과정을 수행하며 데이터 분석이 실제 서비스 흐름 속에서 어떤 역할을 하는지 이해할 수 있었습니다. |
| 이정수 | 데이터 모델링을 바탕으로 프론트엔드와 백엔드를 연결하면서 서비스가 어떻게 설계되는지 경험했습니다. |
| 김태화 | 백엔드부터 클라우드까지 직접 구축하며 서비스가 만들어지는 흐름을 이해할 수 있었습니다. |
