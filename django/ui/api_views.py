...
#     Perfume, PerfumeSeason, PerfumeClassification, UserInfo,
# )
...
#             user_id = int(user_id)
#         except ValueError:
#             return Response({"error": "user_id는 숫자여야 합니다."}, status=status.HTTP_400_BAD_REQUEST)
#
#         try:
#             data = get_user_data(user_id)
#             results = recommend_perfumes(
#                 user_info=[data],
#                 perfume=data["perfumes"],
#                 perfume_classification=list(Perfume.objects.all().values("perfume_id", "fragrance")),
#                 perfume_season=list(Perfume.objects.all().values("perfume_id", "spring", "summer", "fall", "winter")),
